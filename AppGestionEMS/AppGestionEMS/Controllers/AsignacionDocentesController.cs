...
namespace AppGestionEMS.Controllers
{
    ...
    public class AsignacionDocentesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,numCreditos,CursoId,UserId,GrupoId")] AsignacionDocentes asignacionDocentes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,numCreditos,CursoId,UserId,GrupoId")] AsignacionDocentes asignacionDocentes)
        {
            if (ModelState.IsValid)
            {
