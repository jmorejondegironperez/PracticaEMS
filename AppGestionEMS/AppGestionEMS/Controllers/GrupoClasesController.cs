...
namespace AppGestionEMS.Controllers
{
    ...
    public class GrupoClasesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,MaxAlumnos,Aula")] GrupoClases grupoClases)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,MaxAlumnos,Aula")] GrupoClases grupoClases)
        {
            if (ModelState.IsValid)
            {
