namespace AppGestionEMS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<AppGestionEMS.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(AppGestionEMS.Models.ApplicationDbContext context)
        {
            ...
            AddUser(context, "ficticio1", " apellidos ", "ficticio1@alumnos.upm.es", roleTipoUsuario3);
            AddUser(context, "ficticio2", " apellidos ", "ficticio2@alumnos.upm.es", roleTipoUsuario3);
            AddUser(context, "ficticio3", " apellidos ", "ficticio3@alumnos.upm.es", roleTipoUsuario3);
        }
